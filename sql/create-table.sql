...
CREATE TABLE `execution_flows` (
  ...
  `workflow_data` text NOT NULL COMMENT 'short desc of the workflow, contain keys: edges, nodes, extras; edges: [{"startNode": "xxx", "startNode": "xxx"}, ...], nodes: [{"name": "shelljob1", "desc":"shell", "type":"VIRTUAL", "param": {"script": "echo shelljob1"}, "extras": {...}}, ...]',
