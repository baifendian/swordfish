...
public class ScheduleInfo implements org.apache.thrift.TBase<ScheduleInfo, ScheduleInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ScheduleInfo> {
  ...
  public int compareTo(ScheduleInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetCrontab()).compareTo(other.isSetCrontab());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCrontab()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.crontab, other.crontab);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
