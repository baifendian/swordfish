...
public class MasterService {
  ...
  public interface AsyncIface {
    ...
    public void setSchedule(int projectId, int flowId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void deleteSchedule(int projectId, int flowId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void execFlow(int projectId, int flowId, long runTime, ExecInfo execInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void appendWorkFlow(int projectId, int flowId, ScheduleInfo scheduleInfo, ExecInfo execInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void downExecutor(String ip, int port, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class setSchedule_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int flowId;
      public setSchedule_call(int projectId, int flowId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class deleteSchedule_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int projectId;
      private int flowId;
      public deleteSchedule_call(int projectId, int flowId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.projectId = projectId;
        this.flowId = flowId;
      }
    ...
    public static class execFlow_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public execFlow_call(int projectId, int flowId, long runTime, ExecInfo execInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.projectId = projectId;
        this.flowId = flowId;
    ...
    public static class appendWorkFlow_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private ExecInfo execInfo;
      public appendWorkFlow_call(int projectId, int flowId, ScheduleInfo scheduleInfo, ExecInfo execInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.projectId = projectId;
        this.flowId = flowId;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class setSchedule<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, setSchedule_args, RetInfo> {
      ...
      public void start(I iface, setSchedule_args args, org.apache.thrift.async.AsyncMethodCallback<RetInfo> resultHandler) throws TException {
        iface.setSchedule(args.projectId, args.flowId,resultHandler);
      }
    }
    ...
    public static class deleteSchedule<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deleteSchedule_args, RetInfo> {
      ...
      public void start(I iface, deleteSchedule_args args, org.apache.thrift.async.AsyncMethodCallback<RetInfo> resultHandler) throws TException {
        iface.deleteSchedule(args.projectId, args.flowId,resultHandler);
      }
    }
    ...
    public static class execFlow<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, execFlow_args, RetResultInfo> {
      public execFlow() {
        super("execFlow");
      }
      ...
      public AsyncMethodCallback<RetResultInfo> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<RetResultInfo>() { 
          public void onComplete(RetResultInfo o) {
            execFlow_result result = new execFlow_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, execFlow_args args, org.apache.thrift.async.AsyncMethodCallback<RetResultInfo> resultHandler) throws TException {
        iface.execFlow(args.projectId, args.flowId, args.runTime, args.execInfo,resultHandler);
      }
    }
    ...
    public static class appendWorkFlow<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, appendWorkFlow_args, RetResultInfo> {
      public appendWorkFlow() {
        super("appendWorkFlow");
      }
      ...
      public void start(I iface, appendWorkFlow_args args, org.apache.thrift.async.AsyncMethodCallback<RetResultInfo> resultHandler) throws TException {
        iface.appendWorkFlow(args.projectId, args.flowId, args.scheduleInfo, args.execInfo,resultHandler);
      }
    }
    ...
    public static class downExecutor<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, downExecutor_args, RetInfo> {
      public downExecutor() {
        super("downExecutor");
      }
      ...
      public void start(I iface, downExecutor_args args, org.apache.thrift.async.AsyncMethodCallback<RetInfo> resultHandler) throws TException {
        iface.downExecutor(args.ip, args.port,resultHandler);
      }
    }
  ...
  public static class downExecutor_args implements org.apache.thrift.TBase<downExecutor_args, downExecutor_args._Fields>, java.io.Serializable, Cloneable, Comparable<downExecutor_args>   {
  ...
  public static class downExecutor_result implements org.apache.thrift.TBase<downExecutor_result, downExecutor_result._Fields>, java.io.Serializable, Cloneable, Comparable<downExecutor_result>   {
