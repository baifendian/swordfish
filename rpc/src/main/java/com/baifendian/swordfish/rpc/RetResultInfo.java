...
public class RetResultInfo implements org.apache.thrift.TBase<RetResultInfo, RetResultInfo._Fields>, java.io.Serializable, Cloneable, Comparable<RetResultInfo> {
  ...
  public int hashCode() {
    ...
    boolean present_retInfo = true && (isSetRetInfo());
    list.add(present_retInfo);
    if (present_retInfo)
      list.add(retInfo);
