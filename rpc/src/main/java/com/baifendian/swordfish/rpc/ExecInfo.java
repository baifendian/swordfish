...
public class ExecInfo implements org.apache.thrift.TBase<ExecInfo, ExecInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExecInfo> {
  ...
  public ExecInfo(ExecInfo other) {
    ...
    if (other.isSetNotifyMails()) {
      List<String> __this__notifyMails = new ArrayList<String>(other.notifyMails);
  ...
  public int compareTo(ExecInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetNodeDep()).compareTo(other.isSetNodeDep());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNodeDep()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nodeDep, other.nodeDep);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetNotifyMails()).compareTo(other.isSetNotifyMails());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNotifyMails()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.notifyMails, other.notifyMails);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetFailurePolicy()).compareTo(other.isSetFailurePolicy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFailurePolicy()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.failurePolicy, other.failurePolicy);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
