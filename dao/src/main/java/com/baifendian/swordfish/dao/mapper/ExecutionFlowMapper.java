...
//      @Result(property = "duration", column = "duration", javaType = int.class, jdbcType = JdbcType.INTEGER)
  ...
  @SelectProvider(type = ExecutionFlowMapperProvider.class, method = "selectPreDate")
  ExecutionFlow selectPreDate(@Param("flowId") int flowId, @Param("date") Date date);
  ...
  @SelectProvider(type = ExecutionFlowMapperProvider.class, method = "selectPreDate2")
  ExecutionFlow selectPreDate2(@Param("flowId") int flowId, @Param("date") Date date);
