...
public interface ScheduleMapper {
  ...
  @Results(value = {
          ...
          @Result(property = "notify_type", column = "notifyType", typeHandler = EnumOrdinalTypeHandler.class, jdbcType = JdbcType.TINYINT),
          ...
          @Result(property = "owner", column = "ownerId", javaType = int.class, jdbcType = JdbcType.INTEGER),
          @Result(property = "last_modify_by", column = "lastModifyById", javaType = int.class, jdbcType = JdbcType.INTEGER),
          @Result(property = "schedule_status", column = "scheduleStatus", typeHandler = EnumOrdinalTypeHandler.class, jdbcType = JdbcType.TINYINT),
  })
