...
public interface ScheduleMapper {
   ...
   */
  @Results(value = {
          @Result(property = "projectName", column = "project_name", id = true, javaType = String.class, jdbcType = JdbcType.VARCHAR),
          @Result(property = "flowName", column = "workflow_name", id = true, javaType = String.class, jdbcType = JdbcType.VARCHAR),
