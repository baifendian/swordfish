...
public interface ScheduleMapper {
    ...
    @Results(value ={
            ...
            @Result(property = "createTime", column = "create_time",  javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "startDate", column = "start_date", javaType = int.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "endDate", column = "end_date", javaType = int.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "nextSubmitTime", column = "next_submit_time", javaType = int.class, jdbcType = JdbcType.INTEGER),
