 ...
 * File Name      : FlowNodeSqlProvider.java
 */
...
public class FlowNodeMapperSqlProvider {
    ...
    /**
     * 批量更新Pos
     * <li>生成 UPDATE ... SET ... WHEN ... THEN 语句<br>
     * 如： UPDATE flows_nodes SET pos_y = CASE id WHEN 0 THEN #{list[0].posY}
     * WHEN 11 THEN #{list[1].posY} END,pos_x = CASE id WHEN 0 THEN
     * #{list[0].posX} WHEN 11 THEN #{list[1].posX} END WHERE id IN (0,11)
     * <p>
     *
     * @param parameter
     * @return sql语句
